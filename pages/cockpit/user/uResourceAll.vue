        ...
        <view class="pie-chart">
          <view class="legend">
            <view class="legend-item">
              <text
                class="iconfont icon-iconUser-JSC-3-2"
                style="width: 60rpx; height: 60rpx"
              ></text>
              <view class="txt">
                <view class="title">年度累计响应次数</view>
                <view class="num"
                  >{{ yearResponseInfo.annualResponseTimes
                  }}<text class="unit">次</text></view
                >
              </view>
            </view>
            <view class="legend-item">
              <text
                class="iconfont icon-iconUser-JSC-3-1"
                style="width: 60rpx; height: 60rpx"
              ></text>
              <view class="txt">
                <view class="title">年度累计响应负荷</view>
                <view class="num"
                  >{{ yearResponseInfo.annualResponseLoad || 0
